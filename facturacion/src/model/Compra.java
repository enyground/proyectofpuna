...
public class Compra  implements java.io.Serializable {
    ...
    public Compra(int compraId, Proveedor proveedor, int nroPrefijo, int nroFactura, Date fecha, Integer proyectoId, Integer actividadId, double precioTotal, int cantidadTotal, Double descuento, Double iva, String pagoContado, String estado, String rucCi, Integer factReferenciada, char esFactura, Date vencimiento, Set pagoFacturas, Set detalleCompras) {
       this.compraId = compraId;
       this.proveedor = proveedor;
       this.nroPrefijo = nroPrefijo;
       this.nroFactura = nroFactura;
